...
- **[prism](https://github.com/minwoo-data/prism)** - 5-agent parallel code review (broader, one-shot).
- **[triad](https://github.com/minwoo-data/triad)** - 3-perspective deliberation for design docs and markdown.
